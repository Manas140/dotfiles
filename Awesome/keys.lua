...
keys.globalkeys = gears.table.join(
    ...
    -- Awesome
    awful.key({metakey},'l',function() awful.util.spawn('awesome -r') end,
    ...
    awful.key({metakey}, 'Escape', awful.tag.history.restore,
              {description='Return To The Last Tab', group='Tags'}),
    ...
    awful.key({metakey}, 'Return', function() awful.util.spawn(terminal) end,
              {description='Terminal Kitty', group='Applications'}),
    awful.key({metakey}, 't', function() awful.util.spawn(editor_launch) end,
              {description='Text Editor Vim', group='Applications'}),
    awful.key({metakey}, 'r', function() awful.util.spawn('rofi -show drun') end,
              {description='Application Launcher Rofi', group='Applications'}),
              awful.key({metakey}, 'b', function() awful.util.spawn('firefox') end,
              {description='Browser Firefox', group='Applications'}),
    ...
    -- Screenshots
    awful.key({metakey}, 'Print', function() awful.util.spawn('flameshot gui -p'..os.getenv('HOME')..'/Pictures') end,
